...
MODEL_INSTANCE_INFERENCE_HEALTH_CHECK_INTERVAL = int(
    os.getenv("GPUSTACK_MODEL_INSTANCE_INFERENCE_HEALTH_CHECK_INTERVAL", 300)
)
MODEL_INSTANCE_INFERENCE_HEALTH_CHECK_FAILURE_THRESHOLD = int(
    os.getenv("GPUSTACK_MODEL_INSTANCE_INFERENCE_HEALTH_CHECK_FAILURE_THRESHOLD", 3)
)
